...
export const NotificationsStep: React.FC<NotificationsStepProps> = () => {
  const { formData, updateNotifications } = useFormStore();
      ...
      <div className={styles.notificationsList}>
        ...
        <div className={styles.notificationItem}>
          <div className={styles.itemHeader}>
            ...
            <Toggle label="" checked={formData.notifications.email} onToggle={handleEmailToggle} />
          </div>
        </div>
        ...
        <div className={styles.notificationItem}>
          <div className={styles.itemHeader}>
            ...
            <Toggle label="" checked={formData.notifications.phone} onToggle={handlePhoneToggle} />
          </div>
              ...
              >
                ...
                >
                  ...
                  <div className={styles.subOptionContent}>
                    ...
                    />
                    <div className={styles.subOptionHint}>Get quick updates via text messages</div>
                  </div>
                </div>
